...
while True:
    ...
    for k1 in state_1:
       if int(state_1[k1]['time']) > lasttime1:
         lasttime1 = state_1[k1]['time']
         kid_1 = k1
    for k2 in state_2:
       if int(state_2[k2]['time']) > lasttime2:
         lasttime2 = state_2[k2]['time']
         kid_2 = k2
    ...
    client.publish("esp8266/led2",state_2[kid_2]['state'])
    #time.sleep(1)
    client.loop_stop()
    client.disconnect()
